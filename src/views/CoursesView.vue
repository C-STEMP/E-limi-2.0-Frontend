                                    ...
                                    <div class="row">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    <label class="text-md text-muted">
                                                        <input class="form-check-input" type="radio" v-model="filter.price"
                                                            value="" />
                                                        All
                                                    </label>
                                                    <label class="text-md text-muted">
                                                ...
                                                <div class="card-body row">
                                                    <label class="text-md text-muted">
                                                        <input class="form-check-input" type="radio"
                                                            v-model="filter.category" :value="undefined" checked />
                                                        All
                                                    </label>
                                                    <label class="text-md text-muted" v-for="category in categories">
                                                        <input class="form-check-input" type="radio"
                                                            v-model="filter.category" value="beginner" />
                                                        {{ category.name }}
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    <label class="text-md text-muted">
                                                        <input class="form-check-input" type="radio" v-model="filter.level"
                                                            value="" />
                                                        All
                                                    </label>
                                                    <label class="text-md text-muted">
                                    ...
                                    <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                                        <a href="javascript:;" class="d-block">
                                            ...
                                            <button href="javascript:;"
                                                class="btn btn-white btn-icon-only btn-rounded z-index-2 position-absolute end-5 top-7"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                aria-label="Add to watchlist" data-bs-original-title="Add to watchlist"
                                                aria-describedby="tooltip580017">
                                                <i class="ni ni-favourite-28"></i>
                                            </button>
                                        </a>
